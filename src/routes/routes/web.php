...
Route::middleware(['auth:sanctum', config('jetstream.auth_session'), 'verified', 'active'])->group(function () {
    ...
    Route::prefix('easyncc')->name('easyncc.')->group(function () {
        ...
        // Pricing Calculator (standalone)
        Route::get('/pricing-calculator', [QuoteWebController::class, 'pricingCalculator'])
        ...
        Route::prefix('dictionaries')->name('dictionaries.')->middleware('role:super-admin,admin')->group(function () {
            ...
            Route::get('/leave-types', function () {
                return inertia('EasyNCC/Dictionaries/LeaveTypes');
            })->name('leave-types');

            Route::get('/vehicle-unavailability-types', function () {
                return inertia('EasyNCC/Dictionaries/VehicleUnavailabilityTypes');
            })->name('vehicle-unavailability-types');
        });

        // Trash (Cestino)
        Route::get('/trash', function () {
            return inertia('EasyNCC/Trash/Index');
        })->name('trash')->middleware('role:super-admin,admin');
        ...
        Route::get('/settings/driver-unavailabilities', function () {
            return inertia('EasyNCC/Settings/DriverUnavailabilities');
        })->name('settings.driver-unavailabilities')->middleware('role:super-admin,admin');

        Route::get('/settings/vehicle-unavailabilities', function () {
            return inertia('EasyNCC/Settings/VehicleUnavailabilities');
        })->name('settings.vehicle-unavailabilities')->middleware('role:super-admin,admin');
