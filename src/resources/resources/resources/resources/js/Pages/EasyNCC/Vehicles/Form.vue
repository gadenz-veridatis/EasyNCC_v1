            ...
            <BCol lg="12">
                <BCard no-body>
                    ...
                    <BCardBody>
                        ...
                        <div v-if="isEdit && props.vehicle?.id">
                            <VehicleMileageEntries :vehicle-id="props.vehicle.id" />
                        </div>
                        <div v-else class="mt-4 pt-4 border-top">
                            <h6 class="text-muted mb-3">
                                <i class="ri-speed-up-line me-2"></i>Registro Chilometraggio
                            </h6>
                            <div class="alert alert-info mb-0">
                                <i class="ri-information-line me-2"></i>
                                La sezione registro chilometraggio sarà disponibile dopo aver creato il veicolo.
                            </div>
                        </div>
