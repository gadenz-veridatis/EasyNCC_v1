                ...
                <BCard no-body>
                    ...
                    <BCardBody>
                        ...
                        <form v-else @submit.prevent="submitForm">
                            ...
                            <!-- Driver Unavailabilities (only in edit mode for driver role) -->
                            <div v-if="isEdit && form.role === 'driver' && props.user?.id">
                                <DriverUnavailabilities :user-id="props.user.id" />
                            </div>
...
import DriverUnavailabilities from '@/Components/ProfileFields/DriverUnavailabilities.vue';
