        ...
        onMounted(async () => {
            ...
            if (isEdit.value && props.transaction) {
                form.value = {
                    ...
                    transaction_date: props.transaction.transaction_date ? moment.utc(props.transaction.transaction_date).format('YYYY-MM-DD') : '',
                    ...
                    document_due_date: props.transaction.document_due_date ? moment.utc(props.transaction.document_due_date).format('YYYY-MM-DD') : '',
                    payment_date: props.transaction.payment_date ? moment.utc(props.transaction.payment_date).format('YYYY-MM-DD') : '',
