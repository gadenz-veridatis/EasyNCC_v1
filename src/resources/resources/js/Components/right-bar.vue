...
<template>
  <div>
    ...
    <!-- Theme customizer button removed -->
    <BOffcanvas class="border-0" id="theme-settings-offcanvas" header-class="d-flex align-items-center bg-primary bg-gradient p-3" body-class="p-0" z-index="1005" footer-class="offcanvas-footer border-top p-3 text-center" placement="end" v-model="show">
      ...
      <simplebar class="h-100">
        <div class="p-4">
          <h6 class="mb-0 fw-semibold text-uppercase fs-12 fs-12">Layout</h6>
                ...
                <div class="form-check card-radio dark">
                  ...
                  <label class="form-check-label p-0 avatar-md w-100 shadow-sm bg-dark" for="layout-mode-dark">
                    <span class="d-flex gap-1 h-100">
                      ...
                      <span class="flex-grow-1">
                        <span class="d-flex h-100 flex-column">
                          <span class="bg-dark bg-opacity-10 d-block p-1"></span>
            ...
            <BRow>
              ...
              <BCol cols="4">
                <div class="form-check card-radio">
                  ...
                  <label class="form-check-label p-0 avatar-md w-100 shadow-sm px-2" for="sidebar-visibility-hidden">
                    <span class="d-flex gap-1 h-100">
                      <span class="flex-grow-1">
            ...
            <BRow>
              <BCol cols="4">
                <div class="form-check sidebar-setting card-radio">
                  ...
                  <label class="form-check-label p-0 avatar-md w-100 shadow-sm" for="preloader-view-custom">
                    <span class="d-flex gap-1 h-100">
                      <span class="flex-shrink-0">
                        <span class="bg-light d-flex h-100 flex-column gap-1 p-1">
                          <span class="d-block p-1 px-2 bg-primary-subtle rounded mb-2"></span>
              ...
              <BCol cols="4">
                <div class="form-check sidebar-setting card-radio">
                  ...
                  <label class="form-check-label p-0 avatar-md w-100 shadow-sm" for="preloader-view-none">
                    <span class="d-flex gap-1 h-100">
                      <span class="flex-shrink-0">
                        <span class="bg-light d-flex h-100 flex-column gap-1 p-1">
                          <span class="d-block p-1 px-2 bg-primary-subtle rounded mb-2"></span>
