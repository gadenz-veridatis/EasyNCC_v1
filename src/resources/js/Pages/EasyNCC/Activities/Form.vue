...
onMounted(async () => {
    ...
    if (isEdit.value && props.activity) {
        form.value = {
            ...
            start_time: props.activity.start_time ? moment.utc(props.activity.start_time).format('YYYY-MM-DDTHH:mm') : '',
            end_time: props.activity.end_time ? moment.utc(props.activity.end_time).format('YYYY-MM-DDTHH:mm') : '',
